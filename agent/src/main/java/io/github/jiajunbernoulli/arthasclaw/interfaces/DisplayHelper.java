...
public class DisplayHelper {
  ...
  public static void printWelcome() {
    ...
    System.out.println(GREEN + "╔══════════════════════════════════════════════════════════╗" 
        + RESET);
    System.out.println(GREEN + "║          🦞 ArthasClaw TUI - Java Diagnostic Tool         ║" 
        + RESET);
    System.out.println(GREEN + "╚══════════════════════════════════════════════════════════╝" 
        + RESET);
    System.out.println();
  ...
  public static void printConfig(Config config) {
    ...
    System.out.println(
        "  max_tool_result_length: " + config.getAgent().getMaxToolResultLength());
    System.out.println(
        "  list_tools_timeout:     " + config.getAgent().getListToolsTimeoutSeconds() + "s");
    System.out.println(
        "  tool_call_timeout:      " + config.getAgent().getToolCallTimeoutSeconds() + "s");
    System.out.println(
        "  retry_delay:            " + config.getAgent().getRetryDelayMs() + "ms");
    System.out.println();
    ...
    System.out.println();
    System.out.println(
        "Config file: " + ARTHASCLAW_DIR + "/config.yaml");
    System.out.println();
  }
  ...
  public static void printHistory(ArrayNode messages) {
    System.out.println();
    System.out.println(
        CYAN + "Conversation history (" + (messages.size() - 1) + " messages):" + RESET);
    System.out.println();
