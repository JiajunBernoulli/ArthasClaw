...
JAR_URL="https://repo1.maven.org/maven2/io/github/jiajunbernoulli/arthas-claw/0.0.4-beta/arthas-claw-0.0.4-beta-jar-with-dependencies.jar"
JAR_NAME="arthas-claw-0.0.4-beta-jar-with-dependencies.jar"
